...
describe("MRP - constructor", () => {
    it('should return states with 0 rewards', function(){
        ...
        expect(mrp.states).toEqual([{"class": "state", "name": "S0", "r": mrp.states[0].r, "reward": 0, "seed": "0", "terminal": true}, {"class": "state", "name": "S1", "r": mrp.states[0].r, "reward": 0, "seed": "1", "terminal": false}])
    })  
    it('should return states with rewards', function(){
        ...
        expect(mrp.states).toEqual( [{"class": "state", "name": "S0", "r": mrp.states[0].r, "reward": 1, "seed": "0", "terminal": true}, {"class": "state", "name": "S1", "r": mrp.states[0].r, "reward": 2, "seed": "1", "terminal": false}])
    })  
})
