  ...
  render() {
          ...
          <Row>
            <Col xs={4} md={4}>
              <Button
                ...
                type="button"
                onClick={(e) => {
                  this.props.onClickResetStateValue(e, this.props.mp);
                }}
              >
                Reset values to 0
              </Button>
            ...
            <Col xs={4} md={4}>
              <Button
                ...
                type="button"
                onClick={(e) => {
                  this.props.onClickEvaluateStateValue(e, this.props.mp);
                }}
              >
                Evaluate
              </Button>
            ...
            <Col xs={4} md={4}>
              <Button
                ...
                type="button"
                onClick={(e) => {
                  this.props.onClickEvaluateStateValueStep(e, this.props.mp);
                }}
              >
          ...
          <Row>
            <Col xs={4} md={4}>
              <Button
                ...
                type="button"
                onClick={(e) => {
                  this.props.onSelectSwitchAgentEval(e, this.props.agent);
                }}
              >
                {this.props.agent.shouldEvaluate
    ...
    return (
      <Col xs={12} md={6} className="top-margin">
        ...
        />
        <MarkovProcessProps mp={this.props.mp} />
        {valuePanel}
        <AgentDashboard
          ...
          onSelectChangeAgentCurrentState={
            this.props.onSelectChangeAgentCurrentState
          }
        />
      </Col>
    );
